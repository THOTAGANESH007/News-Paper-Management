...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		<div class="col-md-3 text-success">
			<h3>
				<i class="far fa-newspaper"></i> NMS
			</h3>
		</div>
		<div class="col-md-6">
			<form class="form-inline my-2 my-lg-0" action="searchResults.jsp" method="post">
				<input class="form-control mr-sm-2" type="search"
					placeholder="Search by publication or author" aria-label="Search"
					name="searchQuery">
		...
		<div class="col-md-3 text-right">
			...
			<a href="cart.jsp"><i class="fas fa-cart-plus fa-2x"></i></a> <a
				...
				class="fas fa-user-circle"></i> <%=userObj.getName()%>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link"
				href="allNewsPapers.jsp"><i class="fas fa-book-open"></i> News
					Papers</a></li>

			<li class="nav-item active"><a class="nav-link"
				href="allMagazines.jsp"><i class="fas fa-book-open"></i>
					Magazines</a></li>
		</ul>
		<form class="form-inline my-2 my-lg-0">
			<a href="settings.jsp" class="btn btn-light my-2 my-sm-0"
				type="submit"> <i class="fas fa-user-cog"></i> Settings
